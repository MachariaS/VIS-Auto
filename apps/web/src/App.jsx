...
export default function App() {
  ...
  const selectedOrder = filteredProviderOrders.find((orderItem) => orderItem.reference === selectedOrderId) ||
  ...
  useEffect(() => {
    ...
    if (!filteredProviderOrders.some((orderItem) => orderItem.reference === selectedOrderId)) {
                ...
                <span className="order-action-cell-v2">
                  ...
                  {orderActionMenuId === orderItem.reference ? (
                    <div className="order-action-menu-v2">
                      <button
                        type="button"
                        onClick={() => handleOrderRowAction('summary', orderItem)}
                      >
                        Order Summary
                      </button>
                      <button
                        type="button"
                        onClick={() => handleOrderRowAction('message', orderItem)}
                      >
                        Message
                      </button>
